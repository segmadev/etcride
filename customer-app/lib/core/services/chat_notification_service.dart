...
class ChatNotificationService {
  ...
  /// Booking ID of the currently-open chat screen (set by the screen itself).
  static String? activeChatBookingId;

  /// Live per-booking unread counts. Listen to rebuild badges.
  ...
  final Map<String, String> _lastSeenAt = {}; // bookingId → last_message_at
  bool _started = false;
  ...
  Future<void> _poll({bool seed = false}) async {
    ...
    try {
      ...
      for (final t in threads) {
        ...
        // If this chat is currently open, treat as 0 unread (user is reading)
        ...
        // Sound: new message from the other party while screen is not open
