...
/// Stack on top of a map — e.g. an active-trip card. Unlike
/// [showDraggableBottomSheet] this isn't pushed as a route; it's just a
/// widget you place directly in your Stack's children, so it stays visible
/// permanently and the user can drag it down to reveal the map underneath
/// instead of it physically covering the screen with a fixed-height panel.
///
